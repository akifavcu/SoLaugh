...
from src.params import SUBJ_CLEAN, RESULT_PATH, ACTIVE_RUN, PASSIVE_RUN, FIG_PATH
...
def decoding_time(X, y, classifier, cond1, cond2, clf_name, epochs, sfs=True) : 
    ...
    plt.savefig(FIG_PATH + 'ml/sub-01_task-{}_run-all_cond-{}_meas-decoding-time_{}-5_features-50Hz.png'.format(task, conditions, clf_name))
